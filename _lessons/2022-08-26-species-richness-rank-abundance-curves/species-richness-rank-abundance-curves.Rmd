...
Notice that there is some variation in the shape and the "evenness" (i.e., slope) of the different RACs.
...
Also note that differences in sampling can affect the shape of the RACs, which means that one has to be careful to account for sampling effort when comparing RACs from different studies.
