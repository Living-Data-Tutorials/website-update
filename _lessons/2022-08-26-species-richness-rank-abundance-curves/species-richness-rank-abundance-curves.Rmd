...
```{r include=T, message=FALSE, warning=FALSE, code_folding=T}
...
We can see in this table that across years, the number of species in the same area did not fluctuate. 
However, this does not tell us anything about how the abundances of each species changed.
