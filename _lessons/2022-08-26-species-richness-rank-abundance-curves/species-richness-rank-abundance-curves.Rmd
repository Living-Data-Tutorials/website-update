...
4. If the work involves an setting up an experiment, collecting the control vs. experimental groups as well as metrics for replication + statistical power 
...
First you calculate $p_i$, which is the proportion of ith individuals in the community.
...
### Raw 
RACs in nature are rarely as evenly distributed as the simulated data. 
